...
"Cycle Length": cycleData?.cycleLength ? `🟣 ${cycleData.cycleLength} days` : "-",
"Last Period": cycleData?.lastPeriodDate ? `🩸 ${formatDate(cycleData.lastPeriodDate)}` : "-",
...
<Text>Mobile</Text>
<TextInput value={user?.mobile_number} editable={false} style={styles.input}/>
